...
(define tests
  (test-suite
   ...
   (check-equal? (eval-exp (ifgreater (add (int 3) (int 1)) (int 4) (int 3) (int 2))) (int 2) "ifgreater test3")
   ...
   (check-equal? (eval-exp (call (closure '() (fun "sum" "x" (ifgreater (var "x")
                                                                        (int 0)
                                                                        (add (var "x") (call (var "sum") (add (var "x") (int -1))))
                                                                        (int 0)))) (int 4))) (int 10) "call test2")
