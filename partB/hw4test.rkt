...
(define tests
  (test-suite
   ...
   (check-equal? (sequence 5 5 1) (list 5) "Sequence test2")
   (check-equal? (sequence 6 5 1) null "Sequence test3")
   ...
   (check-equal? (list-nth-mod (list 0 1 2 3) 5) 1 "list-nth-mod test2")
 
   ; stream-for-n-steps test
   (check-equal? (stream-for-n-steps ones 2) (list 1 1) "stream-for-n-steps test")
   (check-equal? (stream-for-n-steps ones 4) (list 1 1 1 1) "stream-for-n-steps test2")
   (check-equal? (stream-for-n-steps ones 0) null "stream-for-n-steps test3")
   ...
   (check-equal? (stream-for-n-steps (stream-add-zero dan-then-dog) 2) (list (cons 0 "dan.jpg") (cons 0 "dog.jpg")) "stream-add-zero test2")
   ...
   (check-equal? (vector-assoc 4 (vector (cons 4 2) (cons 3 1) (cons 4 1) (cons 5 1))) (cons 4 2) "vector-assoc test2")
   (check-equal? (vector-assoc 4 (vector (cons 2 1) (cons 3 1) (cons 6 1) (cons 5 1))) #f "vector-assoc test")
